...
class ConsumerAccountSearchResponseBody extends ResponseBody
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount[]
     */
     ...
     * @param \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount[] $consumer_accounts
     */
     ...
     * @param string $response_code
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccountSearchResponseBody
     */
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount[]|null
     */
    ...
    public function setConsumer_accounts(array $consumer_accounts = array())
    {
        foreach ($consumer_accounts as $consumerAccountSearchResponseBodyConsumer_accountsItem) {
            ...
            if (!$consumerAccountSearchResponseBodyConsumer_accountsItem instanceof \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount) {
                throw new \InvalidArgumentException(sprintf('The consumer_accounts property can only contain items of \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount, "%s" given', is_object($consumerAccountSearchResponseBodyConsumer_accountsItem) ? get_class($consumerAccountSearchResponseBodyConsumer_accountsItem) : gettype($consumerAccountSearchResponseBodyConsumer_accountsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount $item
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccountSearchResponseBody
     */
    public function addToConsumer_accounts(\Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount) {
            throw new \InvalidArgumentException(sprintf('The consumer_accounts property can only contain items of \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerAccount, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
