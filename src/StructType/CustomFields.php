...
class CustomFields extends AbstractStructBase
{
     ...
     * @param string $vpos_merchant
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\CustomFields
     */
    public function setVpos_merchant($vpos_merchant = null)
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($vpos_merchant)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $vpos_merchant, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
