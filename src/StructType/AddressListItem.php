...
class AddressListItem extends AbstractStructBase
{
     ...
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\AddressType::valueIsValid()
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\AddressType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $address_type
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\AddressListItem
     */
    public function setAddress_type($address_type = null)
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\AddressType::valueIsValid($address_type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $address_type, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\AddressType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($defaultAddress)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $defaultAddress, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
