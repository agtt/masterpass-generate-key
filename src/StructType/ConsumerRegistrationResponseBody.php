...
class ConsumerRegistrationResponseBody extends ResponseBody
{
     ...
     * - minOccurs: 1
     * - nillable: true
     * @var \Enesdayanc\MasterpassGenerateKey\StructType\MPGAccountResponse
     */
    public $mpg_account;
    /**
     ...
     * - minOccurs: 1
     * - nillable: true
     * @var \Enesdayanc\MasterpassGenerateKey\StructType\ExternalAccountResponse
     */
     ...
     * @param \Enesdayanc\MasterpassGenerateKey\StructType\MPGAccountResponse $mpg_account
     * @param \Enesdayanc\MasterpassGenerateKey\StructType\ExternalAccountResponse $external_card_account
     */
    public function __construct($response_description = null, $mpg_account_number = null, \Enesdayanc\MasterpassGenerateKey\StructType\MPGAccountResponse $mpg_account = null, \Enesdayanc\MasterpassGenerateKey\StructType\ExternalAccountResponse $external_card_account = null)
    {
        $this
     ...
     * @param string $response_description
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerRegistrationResponseBody
     */
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerRegistrationResponseBody
     */
    public function setMpg_account(\Enesdayanc\MasterpassGenerateKey\StructType\MPGAccountResponse $mpg_account = null)
    {
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ConsumerRegistrationResponseBody
     */
    public function setExternal_card_account(\Enesdayanc\MasterpassGenerateKey\StructType\ExternalAccountResponse $external_card_account = null)
    {
