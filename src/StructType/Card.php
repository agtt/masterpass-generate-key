...
class Card extends AbstractStructBase
{
     ...
     * @param \Enesdayanc\MasterpassGenerateKey\StructType\AddressListItem $billingAddress
     * @param string $cardHolderName
     * @param string $expireDate
     * @param string $defaultcard
     * @param string $aliasName
     */
    public function __construct($brandId = null, $brandName = null, $accountNumber = null, \Enesdayanc\MasterpassGenerateKey\StructType\AddressListItem $billingAddress = null, $cardHolderName = null, $expireDate = null, $defaultcard = null, $aliasName = null)
    {
        $this
            ->setBrandId($brandId)
     ...
     * Set brandId value
     * @param string $brandId
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\Card
     */
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\Card
     */
    public function setBillingAddress(\Enesdayanc\MasterpassGenerateKey\StructType\AddressListItem $billingAddress = null)
    {
