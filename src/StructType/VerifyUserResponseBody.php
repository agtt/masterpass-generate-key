...
class VerifyUserResponseBody extends ResponseBody
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem
     */
    public $list_items;
    /**
     * The token
     ...
     * @param string $status
     * @param \Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem $list_items
     * @param string $token
     */
    public function __construct($status = null, \Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem $list_items = null, $token = null)
    {
        $this
            ->setStatus($status)
     ...
     * Set status value
     * @param string $status
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\VerifyUserResponseBody
     */
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem|null
     */
     ...
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\VerifyUserResponseBody
     */
    public function setList_items(\Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem $list_items = null)
    {
