...
class ResponseHeader extends AbstractStructBase
{
     ...
     * @param string $response_datetime
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ResponseHeader
     */
    ...
    /**
     * Set send_sms value
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid()
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues()
    ...
    public function setSend_sms($send_sms = null)
    {
        ...
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($send_sms)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $send_sms, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
     ...
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\ISOLanguageAlpha3TCodeType::valueIsValid()
     * @uses \Enesdayanc\MasterpassGenerateKey\EnumType\ISOLanguageAlpha3TCodeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $send_sms_language
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ResponseHeader
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\ISOLanguageAlpha3TCodeType::valueIsValid($send_sms_language)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $send_sms_language, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\ISOLanguageAlpha3TCodeType::getValidValues())), __LINE__);
        }
