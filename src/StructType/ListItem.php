...
class ListItem extends AbstractStructBase
{
     ...
     * @param string $list_item_value_2
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ListItem
     */
    ...
    public function setPrompt_cpin($prompt_cpin = null)
    {
        ...
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($prompt_cpin)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $prompt_cpin, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($is_masterpass_member)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $is_masterpass_member, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
