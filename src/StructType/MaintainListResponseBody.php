...
class MaintainListResponseBody extends ResponseBody
{
     ...
     * @param string $list_item_value_1
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\MaintainListResponseBody
     */
    ...
    public function setConsumer_account_deleted($consumer_account_deleted = null)
    {
        ...
        if (!\Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::valueIsValid($consumer_account_deleted)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $consumer_account_deleted, implode(', ', \Enesdayanc\MasterpassGenerateKey\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
