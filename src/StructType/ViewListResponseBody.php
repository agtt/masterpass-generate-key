...
class ViewListResponseBody extends ResponseBody
{
     ...
     */
    public function __construct($account_status = null, \Enesdayanc\MasterpassGenerateKey\ArrayType\ArrayOfListItem $list_items = null)
    {
        $this
     ...
     * @param string $account_status
     * @return \Enesdayanc\MasterpassGenerateKey\StructType\ViewListResponseBody
     */
